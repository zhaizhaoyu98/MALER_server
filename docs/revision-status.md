...
| 本地浏览器验收 | 已完成 | 27/27 鼠标交互通过；无破图、横向溢出、控制台或资源错误 |
...
| 阿里云最新版本 | 延后 | 线上为 `13d6b3e`，未更新到 review3 |
...
这些工作不是本次 `v1.0.0-review3` 的完成条件，也不得用虚构数据替代。
